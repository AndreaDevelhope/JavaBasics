...
public class Main {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1:");
        String morningMessage = "Good morning! The sun is shining.";
        System.out.println(morningMessage.toLowerCase());
        System.out.println(morningMessage.toUpperCase());
    }
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "" + 12 + true + 2.5 + 'C'; // <--- Edit this line
