...
public class Main {
    ...
    private static void exercise4Bonus() {
        ...
        // pone il valore a potenza del numero scelto, in questo caso alla seconda
        System.out.println(ourValue + " after using powerOf with the value of 2=" + Math.pow(ourValue, 2));
        // pone il valore a potenza del numero scelto, in questo caso alla terza
        System.out.println(ourValue + " after using powerOf with the value of 3=" + Math.pow(ourValue, 3));
        // moltiplica il valore per un numero random?
        System.out.println(ourValue + " times random =" + Math.random() * ourValue);
        // ho letto i suggerimenti dopo aver completato l'esercizio, molto interessanti, giocando con il valore ourValue forse avrei capito il sesto :P
    }
}